 ...
 * @author mikeburton
 *
 *         Run: For JettyServlet, Browse to http://localhost:7070/example For
 *         webapp in index.html, *.js etc, Browse to just http://localhost:7070
 */
public class EmbeddedJettyMain {
	...
	public static void main(String[] args) throws Exception {
		...
		// ^So as to run the index.html there (= webapp) by browsing just
		// http://localhost:7070
		...
		serHol.setInitParameter("jersey.config.server.provider.packages", "informed.dev.rest");
